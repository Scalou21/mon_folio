...
export default function SocialList() {
  return (
    <ul className="fa-9x has-text-black is-flex is-flex-direction-column is-align-items-center flex-column-mobile flex-row-mobile fs-6-mobile fs-6-tablet fs-12-fullhd">
